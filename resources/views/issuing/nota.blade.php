...
<div class="modal" id="modal-print">
    <div class="modal-dialog">
        <div class="modal-content"> 
            <form id="nota" action="{{ route('issuing.pdf')}}" method="Post" target="_blank">
                <!-- <form id="nota" method="Post" target="_blank"> -->
                @csrf
            <!-- {{csrf_field() }} {{ method_field('POST') }} -->
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn-nota btn-primary" id="btn-nota" name="btn-nota" type="submit">
                            Print
                        </button>
