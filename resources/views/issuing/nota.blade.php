                ...
                <div class="modal-body">
                   ...
                   <!--  <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="facture" name="facture" type="text" autofocus required> 
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="grandtot" name="grandtot" required type="text">
                        <span class="help-block with errors0"></span>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="cash" name="cash" required="" type="text">
                        <span class="help-block with errors0"></span>
                    </div>
                    <div class="form-group">
                        <label>
                        ...
                        <input class="form-control" id="kembali" name="kembali" required="" type="text">
                        <span class="help-block with errors0"></span>
                    </div>
                </div>
