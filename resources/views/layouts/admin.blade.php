...
<script src="{{ asset('public/plugins/jquery/jquery.min.js') }}"></script>
    <script src="{{ asset('public/plugins/jquery/jquery-ui.min.js') }}"></script>
    <script>
    ...
    <script src="{{ asset('public/plugins/jquery/raphael-min.js') }}"></script>
    ...
    <script src="{{ asset('public/plugins/jQuery/moment.min.js') }}"></script>
